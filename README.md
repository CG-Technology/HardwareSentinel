...
- **💽 Deep Storage Inspection**: Reads SMART drive status, physical bus type (NVMe, SSD, HDD), media type, volume capacity, and remaining free space. Flags low disk space (<15% warning, <5% critical).
