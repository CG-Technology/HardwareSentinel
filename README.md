...
- **🌲 Interactive TreeSize Disk Space Analyzer**: Click into the Storage section to launch an interactive, hierarchical disk visualizer with lazy-loaded folder navigation, size percentage bars, and a **Largest Files Finder** (files >= 50MB) with one-click "Open in File Explorer".
